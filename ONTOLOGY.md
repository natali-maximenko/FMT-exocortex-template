...
|------------|-----------|-------|
| `natali-maximenko` | GitHub username | setup.sh |
| `/home/natalia/Github` | Рабочая директория | setup.sh |
| `4` | Час запуска стратега (UTC) | setup.sh |
| `4:00 UTC` | Описание времени | setup.sh |
| `claude` | Путь к Claude CLI | setup.sh |
| `/home/natalia` | Домашняя директория | setup.sh |
| `-home-natalia-Github` | Slug проекта Claude | setup.sh |
