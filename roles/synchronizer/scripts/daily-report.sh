...
LOG_DIR="/home/natalia/logs/synchronizer"
STRATEGY_DIR="/home/natalia/Github/DS-strategy"
...
STRATEGIST_LOG="/home/natalia/logs/strategist/$DATE.log"
...
"
        if echo "$warnings" | grep -q "push failed" 2>/dev/null; then
            report+="- **push failed:** Mac был оффлайн. Запусти \`cd /home/natalia/Github/DS-strategy && git pull --rebase && git push\`
"
        fi
    else
        report+="
