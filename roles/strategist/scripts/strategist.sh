...
notify_telegram() {
    local scenario="$1"
    "/home/natalia/Github/FMT-exocortex-template/roles/synchronizer/scripts/notify.sh" strategist "$scenario" >> "$LOG_FILE" 2>&1 || true
}
...
case "$1" in
    ...
    "week-review")
        ...
        KI_REPO="/home/natalia/Github/DS-Knowledge-Index-natali-maximenko"
