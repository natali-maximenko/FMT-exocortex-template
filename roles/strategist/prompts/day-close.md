...
Источник сценария: /home/natalia/Github/CLAUDE.md → Протокол Day-Close

## Контекст

- **WeekPlan:** /home/natalia/Github/DS-strategy/current/WeekPlan W*.md (последний по дате)
- **MEMORY:** ~/.claude/projects/-home-natalia-Github/memory/MEMORY.md
- **Exocortex backup:** /home/natalia/Github/DS-strategy/exocortex/
...
git -C /home/natalia/Github/<repo> log --since="today 00:00" --oneline --no-merges
```
...
Скопируй актуальные файлы в `/home/natalia/Github/DS-strategy/exocortex/`:

```bash
# Корневой CLAUDE.md
cp /home/natalia/Github/CLAUDE.md /home/natalia/Github/DS-strategy/exocortex/CLAUDE.md

# Memory (Слой 3)
cp ~/.claude/projects/-home-natalia-Github/memory/MEMORY.md /home/natalia/Github/DS-strategy/exocortex/MEMORY.md
cp ~/.claude/projects/-home-natalia-Github/memory/*.md /home/natalia/Github/DS-strategy/exocortex/
```
